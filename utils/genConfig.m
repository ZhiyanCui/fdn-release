...
switch(dataset)
    case {'otb'}
        ...
        benchmarkSeqHome ='/home/zycui/zycui_data//data_seq/otb100/';
    ...
    case {'vot2013','vot2014','vot2015','vot2016','vot2017'}
        % path to VOT dataset
        benchmarkSeqHome = ['/home/zycui/zycui_data//data_seq/vot/', dataset(end-3:end)];
