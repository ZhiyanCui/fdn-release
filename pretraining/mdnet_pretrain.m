...
net = change_net(net,opts);

if isfield(net,'meta')
    opts.train.averageImage = zeros(1,1,3);
    
    opts.train.averageImage(1)=mean(net.meta.normalization.averageImage(:,1));
    opts.train.averageImage(2)=mean(net.meta.normalization.averageImage(:,2));
    opts.train.averageImage(3)=mean(net.meta.normalization.averageImage(:,3));
end
...
%% Save the original net

net_ori = vl_simplenn_move(net,'cpu');
layers_ori = net_ori.layers;
save('net_ori.mat', 'layers_ori') ;
